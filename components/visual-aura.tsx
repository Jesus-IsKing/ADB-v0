...
export const VisualAura: React.FC = () => {
    return (
        <div className="fixed top-0 left-0 w-full h-full pointer-events-none -z-10 overflow-hidden">
            <div
                className="aura-blob w-[min(80vw,800px)] h-[min(80vw,800px)] top-[-100px] left-[-100px]"
                style={{
                    animationDelay: '0s',
            ...
            />
            <div
                className="aura-blob w-[min(100vw,1000px)] h-[min(100vw,1000px)] bottom-[-200px] right-[-100px]"
                style={{
                    animationDelay: '5s',
            ...
            />
            <div
                className="aura-blob w-[600px] h-[600px] top-[20%] right-[-100px] hidden lg:block"
                style={{
                    animationDelay: '10s',
